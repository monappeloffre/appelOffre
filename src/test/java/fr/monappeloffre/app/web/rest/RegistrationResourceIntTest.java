...
import fr.monappeloffre.app.repository.RegistrationRepository;
...
public class RegistrationResourceIntTest {
    ...
    public void setup() {
        ...
        RegistrationResource registrationResource = new RegistrationResource(registrationRepository);
