...
public class ProviderResourceIntTest {
    ...
    public void setup() {
        ...
        ProviderResource providerResource = new ProviderResource(providerRepository);
    ...
    public void createProvider() throws Exception {
        ...
        assertThat(testProvider.getIdUser()).isEqualTo(DEFAULT_ID_USER);
    ...
    public void updateProvider() throws Exception {
        ...
        Provider testProvider = providerList.get(providerList.size() - 1);
        assertThat(testProvider.getIdUser()).isEqualTo(UPDATED_ID_USER);
